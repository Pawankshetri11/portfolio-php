    ...
    <div class="admin-card border-gold-400/30 w-full max-w-2xl transform scale-95 transition-transform duration-300 max-h-[95vh] overflow-y-auto" id="projectModalContent">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="col-span-2 md:col-span-1">
                ...
                <input type="text" class="admin-input" placeholder="e.g., Smart Mood Enhancer">
            </div>

            <!-- Category Selection -->
            <div class="col-span-2 md:col-span-1">
                <label class="admin-label">Category</label>
                <select class="admin-select text-zinc-300">
            ...
            <div class="col-span-2">
                ...
                <textarea class="admin-input h-24 resize-none text-sm" placeholder="Briefly describe the project..."></textarea>
            </div>

            <div class="col-span-2">
                <label class="admin-label">Tech Stack (Comma separated tags)</label>
                <input type="text" class="admin-input" placeholder="Python, React, Node.js, SQL...">
            </div>

            <div class="col-span-2 md:col-span-1">
                <label class="admin-label flex items-center gap-2"><i data-lucide="github" class="w-3 h-3"></i> GitHub Link</label>
                <input type="url" class="admin-input" placeholder="https://github.com/...">
            </div>

            <div class="col-span-2 md:col-span-1">
                <label class="admin-label flex items-center gap-2"><i data-lucide="external-link" class="w-3 h-3"></i> Live Demo Link</label>
                <input type="url" class="admin-input" placeholder="https://...">
            </div>
        </div>
        ...
        <div class="mt-6 flex justify-end gap-3 border-t border-white/5 pt-4">
            ...
            <button onclick="closeProjectModal()" class="bg-gold-400 text-black font-bold px-6 py-2 rounded-lg text-sm">Save Changes</button>
        </div>
    </div>
</div>