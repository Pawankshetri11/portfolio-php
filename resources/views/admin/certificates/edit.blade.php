...
<div class="container">
    ...
    <form action="{{ route('admin.certificates.update', $certificate->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="issuing_organization" name="issuing_organization" value="{{ old('issuing_organization', $certificate->issuing_organization) }}" required>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="issue_date" name="issue_date" value="{{ old('issue_date', $certificate->issue_date->format('Y-m-d')) }}" required>
            @error('issue_date')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon', $certificate->icon) }}" required>
            @error('icon')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
        <div class="mb-3">
            ...
            <select class="form-control" id="view_type" name="view_type" required>
                <option value="link" {{ old('view_type', $certificate->view_type) == 'link' ? 'selected' : '' }}>Link</option>
                <option value="image" {{ old('view_type', $certificate->view_type) == 'image' ? 'selected' : '' }}>Image</option>
            </select>
            @error('view_type')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" id="credential_url" name="credential_url" value="{{ old('credential_url', $certificate->credential_url) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="certificate_image" name="certificate_image" value="{{ old('certificate_image', $certificate->certificate_image) }}">
